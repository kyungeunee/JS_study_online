...
const strEmail = 'gi0@naver.com'
console.log(strEmail.match(/.+(?=@)/)) //["gim530", index: 0, input: "gi@naver.com", groups: undefined]
...
console.log(targetObj) //{name: "Tina", age: 22, email: "gi@.naver.com"}
console.log(userAge) //{name: "Tina", age: 22, email: "gi@.naver.com"}
...
//콜백함수를 반복적으로 사용. 
console.log(values) //["Tina", 22, "gi@naver.com"]
...
console.log(`${nickname}의 이메일 주소는 ${email}입니다.`) //Tina의 이메일 주소는 gi@naver.com입니다.
...
user8.emails.push('gi@gmail.com')
...
userA.emails.push('gi@gmail.com')
